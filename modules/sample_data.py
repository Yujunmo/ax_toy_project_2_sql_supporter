...
def insert_sample_data_new_tables():
    ...
    # 신탁 펀드 정보 (tru_fund_infr_bs) - 삼성자산운용 (F001~F010)
    funds = [
        ('F001', '삼성 200', '20200101', None, 'Y', 'F', 'F', 'KRW', 'MGR001', 'A'),
        ('F002', '삼성 성장형', '20210301', None, 'Y', 'F', 'F', 'KRW', 'MGR002', 'B'),
        ('F003', '삼성 고배당', '20190615', None, 'Y', 'F', 'F', 'KRW', 'MGR003', 'A'),
        ('F004', '삼성 글로벌 선진국', '20220101', None, 'Y', 'F', 'F', 'USD', 'MGR004', 'C'),
        ('F005', '삼성 배당', '20210615', None, 'Y', 'F', 'F', 'KRW', 'MGR005', 'A'),
        ('F006', '삼성 기술', '20220101', None, 'Y', 'F', 'F', 'KRW', 'MGR006', 'B'),
        ('F007', '삼성 에너지', '20220615', None, 'Y', 'F', 'F', 'KRW', 'MGR007', 'B'),
        ('F008', '삼성 인프라', '20230101', None, 'Y', 'F', 'F', 'KRW', 'MGR008', 'A'),
        ('F009', '삼성 글로벌 채권', '20230301', None, 'Y', 'F', 'F', 'USD', 'MGR009', 'C'),
        ('F010', '삼성 혼합', '20230701', None, 'Y', 'F', 'F', 'KRW', 'MGR010', 'A'),
    ]
