...
def insert_sample_data_new_tables():
    ...
    # 신탁 펀드 정보 (tru_fund_infr_bs) - 삼성자산운용
    funds = [
        ('F001', '삼성 200', '20200101', None, 'Y', 'F', 'KRW', 'MGR001', 'A'),
        ('F002', '삼성 성장형', '20210301', None, 'Y', 'F', 'KRW', 'MGR002', 'B'),
        ('F003', '삼성 고배당', '20190615', None, 'Y', 'F', 'KRW', 'MGR003', 'A'),
        ('F004', '삼성 글로벌 선진국', '20220101', None, 'Y', 'F', 'USD', 'MGR004', 'C'),
    ]
